...
// node_modules/@libsql/hrana-client/lib-esm/http/stream.js
var _client3, _baseUrl, _jwt, _fetch2, _remoteEncryptionKey, _baton, _queue3, _flushing, _cursor2, _closing2, _closeQueued, _closed6, _sqlIdAlloc2, _sendStreamRequest2, sendStreamRequest_fn2, _pushToQueue2, pushToQueue_fn2, _flushQueue2, flushQueue_fn2, _flushPipeline, flushPipeline_fn, _flushCursor, flushCursor_fn, _flush, flush_fn, _createPipelineRequest, createPipelineRequest_fn, _createCursorRequest, createCursorRequest_fn, _createRequest, createRequest_fn;
var HttpStream = class extends Stream {
  ...
  constructor(client, baseUrl, jwt, customFetch, remoteEncryptionKey) {
    ...
    __privateAdd(this, _fetch2, void 0);
    __privateAdd(this, _remoteEncryptionKey, void 0);
...
flush_fn = function(createRequest, decodeResponse, getBaton, getBaseUrl, handleResponse, handleError) {
  ...
  try {
    ...
    const fetch3 = __privateGet(this, _fetch2);
...
var _url, _jwt2, _fetch3, _remoteEncryptionKey2, _closed7, _streams, _setClosed3, setClosed_fn3;
var HttpClient = class extends Client {
  ...
  constructor(url, jwt, customFetch, remoteEncryptionKey, protocolVersion = 2) {
    ...
    __privateAdd(this, _remoteEncryptionKey2, void 0);
    ...
    __privateSet(this, _fetch3, customFetch ?? import_cross_fetch2.fetch);
  ...
  openStream() {
    ...
    const stream = new HttpStream(this, __privateGet(this, _url), __privateGet(this, _jwt2), __privateGet(this, _fetch3), __privateGet(this, _remoteEncryptionKey2));
...
var WsClient2 = class {
  ...
  async reconnect() {
    ...
    const next = __privateMethod(this, _openConn, openConn_fn).call(this);
...
var HttpClient2 = class {
  ...
  constructor(url, authToken, intMode, customFetch, concurrency, remoteEncryptionKey) {
    ...
    __privateAdd(this, _intMode2, void 0);
    __privateAdd(this, _customFetch, void 0);
    __privateAdd(this, _concurrency, void 0);
    __privateAdd(this, _authToken2, void 0);
    __privateAdd(this, _remoteEncryptionKey3, void 0);
